...
- (void)initializeInterface {
    UIView *customNavView = [[UIView alloc]initWithFrame:CGRectMake(0, 64, SCREEN_WIDTH, 64)];
    ...
    UIView *currentCityBgView = [[UIView alloc]initWithFrame:CGRectMake(0, 128, SCREEN_WIDTH, 50)];
    ...
    currentCityLabel.backgroundColor = [UIColor yellowColor];
    
    currentCityLabel.text = @"当前定位城市：成都";
...
- (UITextField *)searchTextField {
    if (!_searchTextField) {
        _searchTextField = ({
            ...
            textField.frame = CGRectMake(20, 7, SCREEN_WIDTH - 100, 50);
...
-(UITableView *)tableView {
    if (!_tableView) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 178, SCREEN_WIDTH, SCREEN_HEIGHT-178) style:UITableViewStylePlain];
